...
Uni-3DAR[^uni3dar] sits alongside molxformer on equivariance and pair-rep (drops both) but keeps locality — buried in the octree tokenizer rather than the attention. Locality is thus a third axis, separable from the equivariance and pair-rep axes.
