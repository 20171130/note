...
Start the day by discussing Henry's plan. Schedule open tasks into available time slots. Send an intuitive list of due and available tasks.
...
- 📅 due — actual date the event/deadline occurs
